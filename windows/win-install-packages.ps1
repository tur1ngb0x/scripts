...
# drivers
Invoke-WebRequest -Uri 'https://github.com/abbodi1406/vcredist/releases/download/v0.77.0/VisualCppRedist_AIO_x86_x64.exe' -OutFile driver-vcredist.exe
...
Invoke-WebRequest -Uri 'https://downloadmirror.intel.com/781650/gfx_win_101.2125.exe' -OutFile driver-intel.exe
Invoke-WebRequest -Uri 'https://us.download.nvidia.com/Windows/546.17/546.17-notebook-win10-win11-64bit-international-dch-whql.exe' -OutFile driver-nvidia.exe
Invoke-WebRequest -Uri 'https://glenn.delahoy.com/downloads/sdio/SDIO_1.12.17.757.zip' -OutFile driver-sdio.zip
...
Invoke-WebRequest -Uri 'https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-full.7z' -OutFile app-ffmpeg.7z
Invoke-WebRequest -Uri 'https://github.com/winpython/winpython/releases/download/7.0.20230928/Winpython64-3.11.5.0dot.exe' -OutFile app-python.exe
Invoke-WebRequest -Uri 'https://github.com/git-for-windows/git/releases/download/v2.43.0.windows.1/PortableGit-2.43.0-64-bit.7z.exe' -OutFile app-git.exe

# games
Invoke-WebRequest -Uri 'https://github.com/mgba-emu/mgba/releases/download/0.10.2/mGBA-0.10.2-win64-installer.exe' -OutFile game-mgba.exe
...
Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/massgravel/Microsoft-Activation-Scripts/master/MAS/All-In-One-Version/MAS_AIO.cmd' -OutFile script-win-mas.cmd
